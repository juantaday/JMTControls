...
{
    partial class JMTabControl
    {
        internal partial class CaptionColorChooser : Form
        {
            #region Instance Members

            public JMTabControl contextInstance;
            ...
            {
                Randomizer = new JMTabControl.RandomizerCaption((byte)nmrRed.Value, (byte)nmrGreen.Value, (byte)nmrBlue.Value, (byte)nmrAlpha.Value,
