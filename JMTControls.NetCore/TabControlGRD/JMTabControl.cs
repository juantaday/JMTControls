...
namespace JMTControls.NetCore.TabControlGRD
{
    [Designer(typeof(JMTabControlDesigner))]
            ...
            if (!DesignMode)
            {
                if (drgevent.KeyState == 1 && drgevent.Data.GetDataPresent(typeof(TabPageEx)))
                {
                    ...
                    if (over != null)
                    {
                        ...
                        int draggingTabIndex = ((JMTabControl)draggingTab.Parent).TabPages.IndexOf(draggingTab);
                ...
                if (drgevent.Data.GetDataPresent(typeof(TabPageEx)))
                {
                    ...
                    if (over != null)
                    {
                        ...
                        if (draggingTab != over)
                        {
                            ...
                            {
                                ((JMTabControl)draggingTab.Parent).TabPages.Remove(draggingTab);
...
Finalize:;
            ...
            if (nIndex == this.SelectedIndex)
            {
                ...
                switch (_alignments)
                {
                    ...
                    case TabAlignments.Bottom:
                        ...
                        conditionRectangleArray[0] = new Rectangle()  // Object Initializer(this is rectangle to image button)
                        {
                            X = currentTab.Right - (closeImg.Width + 5),
        ...
        class ButtonsCaptionEditor : UITypeEditor
        {
            ...
            public override void PaintValue(PaintValueEventArgs e)
            {
                if (e.Context.Instance is JMTabControl)
                {
                    JMTabControl parent = e.Context.Instance as JMTabControl;
        ...
        class TabpageExCollectionEditor : CollectionEditor
        {
            ...
            protected override void DestroyInstance(object instance)
            {
                ...
                ISelectionService selectionService = (ISelectionService)GetService(typeof(ISelectionService));
                selectionService.SetSelectedComponents(new IComponent[] { (JMTabControl)Context.Instance }, SelectionTypes.Auto);
            }
    ...
    public class JMTabControlDesigner : System.Windows.Forms.Design.ParentControlDesigner
    {
        #region Instance Members
        ...
        public JMTabControlDesigner()
            : base() {
            System.Diagnostics.Debug.WriteLine("inicializando el diseñador");
        }
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                if (_actionLists == null)
                {
                    ...
                    _actionLists.Add(new KRBTabControlActionList((JMTabControl)Control));
                }
        ...
        public override DesignerVerbCollection Verbs
        {
            get
            {
                if (_verbs == null)
                {
                    ...
                    JMTabControl parentControl = Control as JMTabControl;
        ...
        protected override void PreFilterProperties(System.Collections.IDictionary properties)
        {
            ...
            properties["Location"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
              (PropertyDescriptor)properties["Location"], BrowsableAttribute.No);
            properties["ShowToolTips"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
            ...
            if (parentControl != null)
            {
                ...
                {
                    properties["ItemSize"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["ItemSize"], BrowsableAttribute.No);
                    properties["TabStyles"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["TabStyles"], BrowsableAttribute.No);
                    properties["Alignments"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["Alignments"], BrowsableAttribute.No);
                    properties["UpDownStyle"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["UpDownStyle"], BrowsableAttribute.No);
                    properties["HeaderStyle"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["HeaderStyle"], BrowsableAttribute.No);
                    properties["TabGradient"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["TabGradient"], BrowsableAttribute.No);
                    properties["IsDrawHeader"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["IsDrawHeader"], BrowsableAttribute.No);
                    properties["CaptionButtons"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["CaptionButtons"], BrowsableAttribute.No);
                    properties["TabBorderColor"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["TabBorderColor"], BrowsableAttribute.No);
                    properties["GradientCaption"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["GradientCaption"], BrowsableAttribute.No);
                    properties["BackgroundColor"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["BackgroundColor"], BrowsableAttribute.No);
                    properties["BackgroundImage"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["BackgroundImage"], BrowsableAttribute.No);
                    properties["BackgroundHatcher"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["BackgroundHatcher"], BrowsableAttribute.No);
                    properties["CaptionRandomizer"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                      (PropertyDescriptor)properties["CaptionRandomizer"], BrowsableAttribute.No);
                    properties["IsDrawTabSeparator"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                ...
                if (parentControl.IsDrawHeader)
                {
                    ...
                    {
                        case JMTabControl.TabHeaderStyle.Hatch:
                            properties["BackgroundColor"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                              (PropertyDescriptor)properties["BackgroundColor"], BrowsableAttribute.No);
                            properties["BackgroundImage"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                              (PropertyDescriptor)properties["BackgroundImage"], BrowsableAttribute.No);
                            break;
                        case JMTabControl.TabHeaderStyle.Solid:
                            properties["BackgroundImage"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                              (PropertyDescriptor)properties["BackgroundImage"], BrowsableAttribute.No);
                            properties["BackgroundHatcher"] = TypeDescriptor.CreateProperty(typeof(JMTabControl),
                              (PropertyDescriptor)properties["BackgroundHatcher"], BrowsableAttribute.No);
        ...
        private void OnAddTab(Object sender, EventArgs e)
        {
            ...
            // Notificar al diseñador que la propiedad TabPages ha cambiado.
            TabControl.TabPageCollection oldTabs = parentControl.TabPages;
            RaiseComponentChanging(TypeDescriptor.GetProperties(parentControl)["TabPages"]);

            // Crear una nueva instancia de TabPageEx (asegurándote de que la clase esté disponible)
            TabPageEx newTab = (TabPageEx)_designerHost.CreateComponent(typeof(TabPageEx));
            newTab.Text = "Nuevo Tab"; // Establecer un texto predeterminado

            // Asegurarse de que solo TabPageEx se agregue al control
            if (parentControl.TabPages.Cast<TabPage>().Any(tp => tp is TabPageEx == false))
            {
                // Eliminar tabs de tipo incorrecto
                var incorrectTabs = parentControl.TabPages.Cast<TabPage>()
                                     .Where(tp => !(tp is TabPageEx))
                                     .ToList();
                foreach (var tab in incorrectTabs)
                {
                    parentControl.TabPages.Remove(tab);
                }
            }

            parentControl.TabPages.Add(newTab);  // Agregar el nuevo TabPageEx
            parentControl.SelectedTab = newTab;  // Establecerlo como el tab seleccionado
        ...
        {
            System.Diagnostics.Debug.WriteLine("OnComponentChanged has been called.");

            JMTabControl parentControl = e.Component as JMTabControl;

            if (LicenseManager.UsageMode == LicenseUsageMode.Designtime)
            {
                System.Diagnostics.Debug.WriteLine("Design mode is active.");
            }
    ...
    public class KRBTabControlActionList : DesignerActionList
    {
        ...
        private JMTabControl _linkedControl;
        ...
        public KRBTabControlActionList(JMTabControl control)
            : base(control)
        {
        ...
        public JMTabControl.TabStyle TabStyles
        {
        ...
        public JMTabControl.TabAlignments Alignments
        {
        ...
        public Color FirstColor
        {
            ...
            set
            {
                ...
                {
                    JMTabControl.GradientTab oldGradient = _linkedControl.TabGradient;
