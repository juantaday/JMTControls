...
using static JMTControls.NetCore.ExpandCollapsePanel.ExpandCollapseButton;
...
namespace JMTControls.NetCore.ExpandCollapsePanel
{
    ...
    public partial class ExpandCollapsePanel : Panel
    {
        ...
        /// </summary>
        [Category("ExpandCollapsePanel")]
        [Description("Set or get size image in button")]
        [Browsable(true)]
        public Size ButtonImageSize
        {
            get { return _btnExpandCollapse.ImageSize; }
            set { _btnExpandCollapse.ImageSize = value; }
        }
