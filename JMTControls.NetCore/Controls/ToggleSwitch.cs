...
namespace JMTControls.NetCore.Controls
{
    public class ToggleSwitch : CheckBox 
    {
        ...
        private Color offTextColor = Color.DarkGray;
        private Color onTextColor = Color.Gainsboro;
            ...
            if (this.Checked) //ON
            {
                ...
                if (textEnabled)
                    using (Font font = new Font("Arial", 8.2f * diameter / 30, FontStyle.Bold))
                    {
                        ...
                        pevent.Graphics.DrawString("ON", font, new SolidBrush (OnTextColor), 5, y + 1);
                    }
            ...
            else //OFF
            {
                ...
                if (textEnabled)
                    using (Font font = new Font("Arial", 8.2f * diameter / 30, FontStyle.Bold))
                    {
                        ...
                        pevent.Graphics.DrawString("OFF", font, new SolidBrush(OffTextColor), diameter + 2, y + 1);
                    }
