...
namespace JMTControls.NetCore.Controls  //AllocationRequest
{    
            ...
            foreach (T t in list)
            {
                if (t is DGVPrinter.ImbeddedImage)
                {
                    ...
                    g.DrawImage(ii.theImage,
                        ...
                        new System.Drawing .Size(ii.theImage.Width, ii.theImage.Height)));
                }
            }
        }
    ...
    public class DGVPrinter
    {
        ...
        public class ImbeddedImage
        {
            ...
            internal System.Drawing.Point upperleft(int pagewidth, int pageheight, Margins margins)
            {
                int y = 0;
                int x = 0;
        ...
        bool overridesubtitleformat2 = false;

        // formatted height of subtitle
        float subtitleheight = 0;
        float subtitleheight2 = 0;
        ...
        public Font SubTitleFont2
        {
            get { return subtitlefont2; }
            set { subtitlefont2 = value; }
        }
        ...
        private StringFormat subtitleformat2;
        ...
        public StringAlignment SubTitleAlignment
        {
            ...
            set
            {
                ...
                overridesubtitleformat2 = true;
            }
        }

        public StringAlignment SubTitleAlignment2
        {
            get { return subtitleformat2.Alignment; }
            set
            {
                subtitleformat2.Alignment = value;
                overridesubtitleformat2 = true;
            }
        }
        ...
        private float SubTitleHeight2
        {
            get
            {
                if (PrintLocation.All == SubTitlePrint)
                    return subtitleheight2 + subtitlespacing;
        ...
        public DGVPrinter()
        {
            ...
            subtitlefont2 = new Font("Tahoma", 7, FontStyle.Regular, GraphicsUnit.Point);
            subtitlecolor = Color.Black;
            ...
            buildstringformat(ref subtitleformat, null, StringAlignment.Center, StringAlignment.Center,
                StringFormatFlags.NoWrap | StringFormatFlags.LineLimit | StringFormatFlags.NoClip, StringTrimming.Word);
            buildstringformat(ref subtitleformat2, null, StringAlignment.Center, StringAlignment.Center,
                StringFormatFlags.NoWrap | StringFormatFlags.LineLimit | StringFormatFlags.NoClip, StringTrimming.Word);
        ...
        private void measureprintarea(Graphics g)
        {
            ...
            if (PrintHeader)
            {
                ...
                subtitleheight2 = (g.MeasureString(subtitle2, subtitlefont2, printWidth, subtitleformat)).Height;
            }
        ...
        private bool PrintPage(Graphics g)
        {
            ...
            if (PrintHeader)
            {
                ...
                if (0 != SubTitleHeight2 && !String.IsNullOrEmpty(subtitle2))
                    printsection(g, ref printpos, subtitle2, subtitlefont2,
                        subtitlecolor, subtitleformat2, overridesubtitleformat2,
                        pagesets[currentpageset],
                        subtitlebackground, subtitleborder);


                // account for subtitle spacing
                printpos += SubTitleHeight2;
            }
        ...
        void DrawCheckBoxCell(Graphics g, DataGridViewCheckBoxCell checkboxcell, RectangleF rectf)
        {
            ...
            System.Drawing.Size size = CheckBoxRenderer.GetGlyphSize(tg, state);
            ...
            CheckBoxRenderer.DrawCheckBox(tg, new System.Drawing.Point(x, y), state);
