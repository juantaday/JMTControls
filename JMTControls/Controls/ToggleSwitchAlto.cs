namespace JMControls.Controls
{
    ...
    public class ToggleSwitchAlto : Control
    {
        ...
        public ToggleSwitchAlto()
        {

            Cursor = Cursors.Hand;
            DoubleBuffered = true;

            artis = 8; //increment for sliding animation
            diameter = 24;
            textEnabled = true;
            rect = new RoundedRectangleF(2 * diameter, diameter + 2, diameter / 2, 1, 1);
            circle = new RectangleF(2, 2, diameter-2, diameter-2);
            isOn = true;
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            artis = 4 * diameter / 30;
            rect = new RoundedRectangleF(2 * diameter, diameter + 2, diameter / 2, 1, 1);
            circle = new RectangleF(!isOn ? 2 : Width - diameter - 2, 2, diameter-2, diameter-2);
            base.OnResize(e);
        }
